...
class DPA_bbPress_Extension extends DPA_CPT_Extension {
	...
	public function __construct() {
		...
		$this->id              = 'bbpress';
		$this->image_url       = trailingslashit( achievements()->plugin_url ) . 'admin/images/bbpress.png';
		$this->name            = __( 'bbPress', 'dpa' );
		$this->rss_url         = 'http://bbpress.org/blog/feed/';
		$this->small_image_url = trailingslashit( achievements()->plugin_url ) . 'admin/images/bbpress-small.png';
		$this->version         = 1;
