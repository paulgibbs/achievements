...
class DPA_InviteAnyone_Extension extends DPA_Extension {
	...
	public function __construct() {
		...
		$this->image_url       = trailingslashit( achievements()->includes_url ) . 'admin/images/placeholder.png';
		$this->name            = __( 'Invite Anyone', 'dpa' );
		$this->rss_url         = 'http://teleogistic.net/feed/';
		$this->small_image_url = trailingslashit( achievements()->includes_url ) . 'admin/images/placeholder-small.jpg';
		$this->version         = 1;
